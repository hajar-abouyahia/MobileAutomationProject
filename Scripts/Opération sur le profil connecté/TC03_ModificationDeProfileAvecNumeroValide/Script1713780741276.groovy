...
//The function that inchecks the button to accept the use of data in accordance with the CNSS policy.
...
//String alertPath = verificationKeyword.checkButton
//authkeyword.verifyalertPresent(alertPath, 'Veuillez cocher la case pour continuer')
//Mobile.delay(1)
