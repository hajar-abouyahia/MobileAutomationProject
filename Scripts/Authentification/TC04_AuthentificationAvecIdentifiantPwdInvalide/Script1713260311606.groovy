...
String alertPath = authkeyword.identifiantMdpInvalid

authkeyword.verifyalertPresent(alertPath, 'Identifiant ou mot de passe invalide')

Mobile.delay(1)

//return to authentification page
authkeyword.ReturnToAuthPage()
